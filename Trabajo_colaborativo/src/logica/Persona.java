...
public class Persona {
	...
	public Persona(String documento, String apellido1, String apellido2, String nombre1, String nombre2, Date fechaNac,
			String clave, String mail, Rol rolPersona) {
		super();
	...
	public String toString() {
		return "Persona: " + apellido1 +" "+ apellido2 + " "+ nombre1 + " "+nombre2 + " con fecha de nacimiento: "+fechaNac+ "correo electronico: "+mail+rolPersona;
	}
